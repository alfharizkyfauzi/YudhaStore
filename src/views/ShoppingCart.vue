                            ...
                            <div class="user-checkout text-left">
                                <form>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input @change="handleFileUpload()" type="file" class="form-control" id="bukti" aria-describedby="bukti" placeholder="Upload Bukti Pembayaran" />
                                    </div> -->
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">Ongkos Kirim <span>10% (Rp.{{ditambahPajak}})</span></li>
                                    <li class="subtotal mt-3">Total Biaya <span>Rp.{{totalBiaya}}</span></li>
                                    <li class="subtotal mt-3">Bank Transfer <span>Mandiri</span></li>
                                    <li class="subtotal mt-3">No. Rekening <span>2208 1996 1403</span></li>
                                    <li class="subtotal mt-3">Nama Penerima <span>Yudha</span></li>
                                </ul>
